...
class Solution:
    def getAncestors(self, n: int, edges: List[List[int]]) -> List[List[int]]:
        ...
        for node, node_ancestor in enumerate(ancestors):
            q = deque(node_ancestor)
            visited = set()
            while q:
                parent = q.popleft()
...
print(Solution().getAncestors(8,
                              [[0, 7], [7, 6], [0, 3], [6, 3], [5, 4], [1, 5], [2, 7], [3, 5], [3, 1], [0, 5], [7, 5],
                               [2, 1], [1, 4], [6, 1]]))
