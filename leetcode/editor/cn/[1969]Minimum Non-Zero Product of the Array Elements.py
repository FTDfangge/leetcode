...
# consists of the integers in the inclusive range [1, 2ᵖ - 1] in their binary 
...
#  
# 
#  For example, if x = 1101 and y = 0011, after swapping the 2ⁿᵈ bit from the 
# right, we have x = 1111 and y = 0001. 
# 
#  Find the minimum non-zero product of nums after performing the above 
# operation any number of times. Return this product modulo 10⁹ + 7. 
# 
...
print(Solution().minNonZeroProduct(22))
print(Solution().minNonZeroProduct(30))
